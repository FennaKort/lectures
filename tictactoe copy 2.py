...
# version with the if statements separated
def win_checker(board: list) -> int:
    for index in range(0,3):
        ...
        elif (board[0][0] == -1 and board[0][1] == -1 and board[0][2] == -1) or (board[1][0] == -1 and board[1][1] == -1 and board[1][2] == -1) or (board[2][0] == -1 and board[2][1] == -1 and board[2][2] == -1):
            print("row win")            
            return -1
